...
Do not add this section to any skill file. Do not instruct agents to
produce an Evidence Map in their output. The system produces it
automatically from recorded data.
